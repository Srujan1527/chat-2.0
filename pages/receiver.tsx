...
const Receiver = () => {
  ...
  <form onSubmit={letsGo} className="border-2 w-full h-screen flex justify-center flex-col items-center">
    <div className="w-full sm:w-4/12 border-2 p-4 rounded-lg">
      ...
      <div className="flex">
        <button type="submit" className="w-24 mb-2 ml-8 flex justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          Lets Go
        </button>
        <button type="submit" onClick={getMails} className="w-24 mb-2 ml-8 flex justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          Fetch Mails
        </button>
      </div>
    </div>
    <div className="mt-4 border-2 p-4 w-full sm:w-1/2 rounded-lg flex justify-center">
